...
namespace GetSunRiseSet
{
	...
	public class SunUtil
	{
        ...
        public double calcJD(DateTime date)
        {
        ...
        public string getTimeString(bool min,double time, int timezone, double JD, bool dst)
        {
        ...
        public DateTime? getDateTime(double time, int timezone, DateTime date, bool dst)
        {
